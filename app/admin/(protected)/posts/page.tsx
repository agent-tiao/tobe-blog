  ...
  return (
    <div>
      ...
      {posts.length === 0 ? (
        ...
        <div className="bg-[var(--editor-panel)] rounded-xl border border-[var(--editor-line)]">
          {/* 表头 */}
          <div className="hidden md:grid grid-cols-[50px_1fr_120px_90px_200px] gap-3 px-5 py-3.5 border-b border-[var(--editor-line)] bg-[var(--editor-soft)] rounded-t-xl">
